...
settings.define("mosaic.cluster.role", { description = "Papel no cluster: mestre ou no", type = "string" })
settings.define("mosaic.cluster.group", { description = "Grupo do computador no cluster", type = "string" })
settings.define("mosaic.cluster.master", { description = "Id do mestre; vazio manda por transmissao", type = "number" })
