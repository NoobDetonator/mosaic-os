...
registry.builtin = {
    ...
    { id = "settings", name = "Configuracoes", icon = "Cf", color = colors.gray, desktop = true, path = "/os/apps/settings.lua" },
    { id = "netcenter", name = "Rede", icon = "Nt", color = colors.green, desktop = true, path = "/os/apps/netcenter.lua" },
    ...
    { id = "notes", name = "Notas", icon = "Nt", color = colors.lime, path = "/os/apps/notes.lua" },
    { id = "calc", name = "Calculadora", icon = "+-", color = colors.cyan, path = "/os/apps/calc.lua" },
    { id = "clock", name = "Relogio", icon = "Cl", color = colors.blue, path = "/os/apps/clock.lua" },
